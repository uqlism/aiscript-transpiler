...
export class FunctionsPlugin extends TranspilerPlugin {
    ...
    private convertFunctionDeclaration(node: ts.FunctionDeclaration): Ast.Definition {
        ...
        return {
            ...
            expr: { type: "fn", typeParams: [], params: params, children: finalBody, loc: dummyLoc },
            mut: false,
            attr: [],
            loc: dummyLoc,
        };
    ...
    private convertInlineFunction(node: ts.ArrowFunction | ts.FunctionExpression): Ast.Expression {
        const { params, destructuringStatements } = this.processParameters(node.parameters);
    ...
    ): { params: FnParam[]; destructuringStatements: Ast.Statement[] } {

...
import { convertDestructuringAssignment } from "../../utils/destructuring"
...
export class VariableStatementPlugin extends TranspilerPlugin {
    ...
    private convertVariableStatements(node: ts.VariableStatement): Ast.Statement[] {
        ...
        for (const declaration of node.declarationList.declarations) {
            ...
            if (ts.isIdentifier(nameNode)) {
                ...
                // 分割代入の展開
                const destructuringDefs = convertDestructuringAssignment(nameNode, sourceExpr, isMutable, this.converter);

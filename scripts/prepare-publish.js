...
const typesExist = fs.existsSync(path.join('types', 'aiscript.d.ts')) &&
...
console.log('- Main: import { TypeScriptToAiScriptTranspiler } from "aiscript-transpiler"');
console.log('- Bundler: import { AiScriptBundler } from "aiscript-transpiler/bundler"');
console.log('- Stringifier: import { AiScriptStringifier } from "aiscript-transpiler/stringifier"');
